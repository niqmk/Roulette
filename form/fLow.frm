...
Public Sub SetText()
    Me.lbWin(0).Caption = CStr(mdApp.ILowBox(0))
    Me.lbLoss(0).Caption = CStr(mdApp.ILowBox(1))
    Me.lbWinMax(0).Caption = CStr(mdApp.ILowBox(2))
    Me.lbLossMax(0).Caption = CStr(mdApp.ILowBox(3))
    Me.lbWin(1).Caption = CStr(mdApp.ILowBox(5))
    Me.lbLoss(1).Caption = CStr(mdApp.ILowBox(6))
    Me.lbWinMax(1).Caption = CStr(mdApp.ILowBox(7))
    Me.lbLossMax(1).Caption = CStr(mdApp.ILowBox(8))
    Me.lbCount(0).Caption = " " & Format(mdApp.ILowBox(4), "#,##0")
    Me.lbCount(1).Caption = " " & Format(mdApp.IBoxBaseDec - mdApp.ILowBox(4), "#,##0")
End Sub
