...
Public Sub SetText()
    Me.lbWin(0).Caption = CStr(mdApp.IOddBox(0))
    Me.lbLoss(0).Caption = CStr(mdApp.IOddBox(1))
    Me.lbWinMax(0).Caption = CStr(mdApp.IOddBox(2))
    Me.lbLossMax(0).Caption = CStr(mdApp.IOddBox(3))
    Me.lbWin(1).Caption = CStr(mdApp.IOddBox(5))
    Me.lbLoss(1).Caption = CStr(mdApp.IOddBox(6))
    Me.lbWinMax(1).Caption = CStr(mdApp.IOddBox(7))
    Me.lbLossMax(1).Caption = CStr(mdApp.IOddBox(8))
    Me.lbCount(0).Caption = " " & Format(mdApp.IOddBox(4), "#,##0")
    Me.lbCount(1).Caption = " " & Format(mdApp.IBoxBaseDec - mdApp.IOddBox(4), "#,##0")
End Sub
