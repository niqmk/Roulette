...
Public Sub SetText()
    Me.lbWin(0).Caption = CStr(mdApp.IHighBox(0))
    Me.lbLoss(0).Caption = CStr(mdApp.IHighBox(1))
    Me.lbWinMax(0).Caption = CStr(mdApp.IHighBox(2))
    Me.lbLossMax(0).Caption = CStr(mdApp.IHighBox(3))
    Me.lbWin(1).Caption = CStr(mdApp.IHighBox(5))
    Me.lbLoss(1).Caption = CStr(mdApp.IHighBox(6))
    Me.lbWinMax(1).Caption = CStr(mdApp.IHighBox(7))
    Me.lbLossMax(1).Caption = CStr(mdApp.IHighBox(8))
    Me.lbCount(0).Caption = " " & Format(mdApp.IHighBox(4), "#,##0")
    Me.lbCount(1).Caption = " " & Format(mdApp.IBoxBaseDec - mdApp.IHighBox(4), "#,##0")
End Sub
