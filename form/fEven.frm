...
Public Sub SetText()
    Me.lbWin(0).Caption = CStr(mdApp.IEvenBox(0))
    Me.lbLoss(0).Caption = CStr(mdApp.IEvenBox(1))
    Me.lbWinMax(0).Caption = CStr(mdApp.IEvenBox(2))
    Me.lbLossMax(0).Caption = CStr(mdApp.IEvenBox(3))
    Me.lbWin(1).Caption = CStr(mdApp.IEvenBox(5))
    Me.lbLoss(1).Caption = CStr(mdApp.IEvenBox(6))
    Me.lbWinMax(1).Caption = CStr(mdApp.IEvenBox(7))
    Me.lbLossMax(1).Caption = CStr(mdApp.IEvenBox(8))
    Me.lbCount(0).Caption = " " & Format(mdApp.IEvenBox(4), "#,##0")
    Me.lbCount(1).Caption = " " & Format(mdApp.IBoxBaseDec - mdApp.IEvenBox(4), "#,##0")
End Sub
